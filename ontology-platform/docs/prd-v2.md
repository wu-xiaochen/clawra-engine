...
# v3.3 新增API
POST   /api/v1/extract                # 抽取实体到本体
POST   /api/v1/extract/preview        # 预览抽取结果
PUT    /api/v1/entities/{id}/confidence # 升级置信度
GET    /api/v1/reason/{id}/suggest    # 获取补充建议
```
...
type ReasoningResult {
  ...
  confidence: Confidence!
  timestamp: DateTime!
  suggestions: [Suggestion!]  # v3.3新增：推理失败建议
}

type ExtractionResult {  # v3.3新增
  entities: [Entity!]!
  relations: [Relation!]!
  duplicates: [Entity!]!
  preview: Boolean!
...
type Mutation {
  ...
  # v3.3新增
  extract(text: String!, preview: Boolean): ExtractionResult!
  confirmExtraction(entities: [EntityInput!]!, relations: [RelationInput!]!): Boolean!
  upgradeConfidence(entityId: ID!): Entity!
}
```
